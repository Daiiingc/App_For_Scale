...
class Fsm_State_Change_Value_E(Enum):
    ...
    FSM_STATE_CHANGE_VALUE_LENGTH_DATA  = 3
...
def Fsm_Test_Array_Receive(data_in, array_out):
    ...
    match fsm_state:
        ...
        case Fsm_State_E.FSM_STATE_TYPE_MESSAGE.value:
            array_out.append(data_in)
            fsm_array_out_index += 1
            if(fsm_array_out_index ==  Fsm_State_Change_Value_E.FSM_STATE_CHANGE_VALUE_SENSOR.value):
                fsm_state = Fsm_State_E.FSM_STATE_SENSOR.value
        
        case Fsm_State_E.FSM_STATE_SENSOR.value:
            array_out.append(data_in)
            fsm_array_out_index += 1
        ...
        case Fsm_State_E.FSM_STATE_LENGTH_DATA.value:
            ...
            if(fsm_array_out_index == Fsm_State_Change_Value_E.FSM_STATE_CHANGE_VALUE_END.value):
                fsm_array_full_length = array_out[3] + constant.DEFAULT_LENGTH
                if(fsm_array_full_length <= (constant.DEFAULT_LENGTH + 6)):
